...
namespace ProjectsManager.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(ProjectsManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var projectsManagerContext = _context.Projects.Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,UserId,CreationDate")] Project project)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UserId"] = new SelectList(dropDownList, "Id", "Name", project.UserId);
            return View(project);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,UserId,CreationDate")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
